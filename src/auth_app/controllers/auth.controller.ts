...
// const requiredEnvVars = ['GOOGLE_CLIENT_ID', 'GOOGLE_CLIENT_SECRET', 'FRONTEND_URL'];
...
// const callbackURL = `http://localhost:3000/api/auth/google/secrets`;
...
//       // Redirect to the frontend with the token (hardcoded for local dev)
//       const frontendUrl = process.env.FRONTEND_URL as string;
//       const redirectUrl = new URL(returnTo, frontendUrl);
//       // Add token as query param for clients that can't access httpOnly cookies
